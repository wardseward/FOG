...
<html lang="en">
  <head>
    <?php
		include 'head.php';
	?>
    <title>Game Master Request - Board Game | FOG CON 2015 | Fans Of Gaming (FOG)</title>
  </head>
  ...
  <body>
    ...
    <div class="container">
	<h1>Game Master Request - Board Game</h1>
   ...
   <?php 
		...
		if ($action=="")    /* display the contact form */ 
			{ 
			?> 
            <p>If you are interested in GMing a board game game, please fill out and submit the form below. You should hear back from a FOG member shortly.</p>
...
<small>Please include street address, city, state and zipcode.</small>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label" for="game">Game:</label>  
              <div class="col-md-6">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label" for="description">Game Description:</label>  
              <div class="col-md-6">
              ...
              <small>&nbsp;&nbsp;Max number of players.</small>
              </div>
            </div>
           ...
           <div class="form-group">
			...
			if (($name=="")||($email=="")) 
				...
				$subject = "Game Master Request - Board Game";
				...
				$msg .= "<tr><th colspan='2' align='left' bgcolor='#E11822' style='color:#fff;'>Game Master Request - Board Game</th></tr>";
				...
				$msg .= "<tr><td valign='top'><strong>Game Description:</strong></td><td valign='top'>" . strip_tags($_POST['description']) . "</td></tr>";
	...
	Contact Tom Green at <a href="mailto:fansofgaming@gmail.com">fansofgaming@gmail.com</a>.</p>
    <div>
